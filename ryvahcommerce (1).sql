...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 01, 2025 at 08:56 AM
...
INSERT INTO `addresses` (`id`, `user_id`, `label`, `street`, `city`, `state`, `postal_code`, `country`, `is_default`, `created_at`, `updated_at`) VALUES
(1, 19, 'hyt', 'yyty', 'New York', 'NY', '343', 'US', 1, '2025-05-30 12:37:54', '2025-05-30 12:37:54');
...
(125, 19, 7, 1, '2025-05-31 18:06:15', '2025-05-31 18:06:15');
...
INSERT INTO `orders` (`id`, `invoice_number`, `user_id`, `order_date`, `total_amount`, `tax_amount`, `tax_rate`, `payment_status`, `payment_method`, `paypal_order_id`, `shipping_address`, `billing_address`, `notes`, `created_at`, `updated_at`) VALUES
(66, '', 19, '2025-05-16 10:52:43', 11.99, 0.00, 0.00, 'failed', NULL, NULL, NULL, NULL, NULL, '2025-05-16 07:52:43', '2025-05-21 12:17:51');
