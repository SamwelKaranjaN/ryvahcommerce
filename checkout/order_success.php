                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <div class="text-center mb-4">
                                            ...
                                            <p class="text-muted">Thank you for your purchase. Your order has been
                                        ...
                                        <div class="card shadow-sm mb-4">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    ...
                                                    <div>
                                                        <a href="<?php echo $invoice_path; ?>" class="btn btn-primary"
                                                            target="_blank">
                                                            <i class="fas fa-eye me-2"></i>View Invoice
                                                        </a>
                                                        <a href="<?php echo $invoice_path; ?>"
                                                ...
                                                <div class="order-details mb-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted">
                                                                <?php echo $order['invoice_number']; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    <img src="<?php echo htmlspecialchars($item['thumbs']); ?>" alt=""
                                                        class="item-image me-3">
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-0"><?php echo htmlspecialchars($item['name']); ?>
                                                        </h6>
                                                    ...
                                                    <div class="text-end">
                                                        ...
                                                        <small
                                                            class="text-muted">$<?php echo number_format($item['price'], 2); ?>
                                                            each</small>
                                                    </div>
                                                </div>
                                                <?php endforeach; ?>
