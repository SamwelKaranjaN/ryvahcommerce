...
<head>
    ...
    /* Floating Fairy (hidden on small screens) */
    .hero-fairy-wrapper {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    @media (max-width: 576px) {
        ...
        .hero-section {
            /* Fairy as background, then dark overlay, then bookshelf image */
            background:
                linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                url('../resources/fairy.jpg') left center no-repeat,
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col">
                    ...
                    <h2 class="mb-0 fw-bold text-primary">Checkout</h2>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center checkout-steps">
                                <div class="step active">
                                    <div class="step-icon bg-primary text-white"><i class="fas fa-shopping-cart"></i>
                                    </div>
                                    <div class="step-text">Cart</div>
                                </div>
                                <div class="step active">
                                    <div class="step-icon bg-primary text-white"><i class="fas fa-user"></i></div>
                                    <div class="step-text">Details</div>
                                </div>
                                <div class="step">
                                    <div class="step-icon bg-light text-primary border-primary"><i
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-4 text-primary"><i class="fas fa-user me-2"></i>Billing Information
                            </h5>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-4 text-primary"><i class="fas fa-credit-card me-2"></i>Payment
                                Options</h5>
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <div class="payment-method-card selected d-flex flex-column align-items-center py-3"
                                ...
                                <div class="col-md-6">
                                    <div class="payment-method-card d-flex flex-column align-items-center py-3"
                                        data-method="stripe" onclick="selectPaymentMethod('stripe')">
                            ...
                            <form id="payment-form" style="display:none;">
                                ...
                                <button type="submit" class="btn btn-primary w-100">Pay with Card</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm order-summary-card">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-4 text-primary"><i class="fas fa-shopping-basket me-2"></i>Order
                                Summary</h5>
