...
try {
    ...
    $stmt = $conn->prepare("
        SELECT o.id, o.invoice_number, o.total_amount, o.tax_amount, o.shipping_amount, o.payment_status, 
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tfoot class="table-light">
                            <?php
                            // Calculate subtotal correctly: total - tax - shipping
                            $subtotal_amount = $order['total_amount'] - $order['tax_amount'] - $order['shipping_amount'];
                            ?>
                            <tr>
                                <th colspan="4">Subtotal:</th>
                                <th><?= formatCurrency($subtotal_amount, $currency); ?></th>
                            </tr>
                            <tr>
                                <th colspan="4">Tax:</th>
                            ...
                            <tr>
                                ...
                                <th><?= $order['shipping_amount'] > 0 ? formatCurrency($order['shipping_amount'], $currency) : 'Free'; ?></th>
                            </tr>
