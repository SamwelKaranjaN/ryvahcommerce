...
<head>
    ...
    <title>Checkout - <?= htmlspecialchars(SITE_NAME); ?></title>
    ...
    <script
        ...
        onload="window.paypalSDKLoaded = true;" onerror="console.error('Failed to load PayPal SDK');" async></script>
...
<body>
    ...
    function renderPayPalButtons() {
        ...
        if (typeof paypal === 'undefined') {
            console.log('PayPal SDK not yet loaded, waiting...');
            ...
            const checkPayPalSDK = setInterval(() => {
                ...
                if (typeof paypal !== 'undefined') {
                    ...
                    showError('PayPal SDK failed to load. Please refresh the page and try again.');
                }
            }, 100);
    ...
    function initializePayPalButtons() {
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                ...
                return fetch('simple_capture.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
