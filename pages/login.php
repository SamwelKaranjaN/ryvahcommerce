        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST"
                        action="<?php echo $_SERVER['PHP_SELF'] . (isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''); ?>">
                        <div class="mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (redirect) {
        ...
        form.action = form.action + (form.action.includes('?') ? '&' : '?') + 'redirect=' + encodeURIComponent(
            redirect);
