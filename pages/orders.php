...
<div class="orders-responsive-container">
...
<style>
    .orders-responsive-container .container {
        max-width: 100vw;
    }
    ...
    @media (max-width: 991.98px) {
        ...
        .orders-responsive-container .row {
            flex-direction: column;
        }

        .orders-responsive-container .card.border-0.shadow-sm {
            margin-bottom: 1.2rem;
            border-radius: 12px;
            padding: 0.7rem 0.2rem;
        }

        .orders-responsive-container .card-body {
            padding: 1rem 0.5rem !important;
        }

        .orders-responsive-container .timeline-content {
            padding: 10px;
            font-size: 0.98rem;
        }

        .orders-responsive-container .timeline-marker {
            width: 12px;
            height: 12px;
        }

        .orders-responsive-container .timeline-item {
            padding-left: 28px;
        }

        .orders-responsive-container .btn,
        .orders-responsive-container .btn-lg,
        .orders-responsive-container .btn-primary,
        .orders-responsive-container .btn-outline-primary {
            font-size: 1rem;
        ...
        .orders-responsive-container .text-end {
    ...
    @media (max-width: 767.98px) {
        ...
        .orders-responsive-container .card-title {
            font-size: 1.1rem;
        }

        .orders-responsive-container .modal-dialog {
            margin: 0.5rem;
            max-width: 98vw;
        }
    }
